...
class StatsdReporter {
    ...
    item(err, args) {
        ...
        this.stream.write(`api.${metricname}.responseCode:${responseCode}|g`);
        this.stream.write(`api.${metricname}.duration:${duration}|ms`);
        this.stream.write(`api.${metricname}.passed:${passed}|g`);
